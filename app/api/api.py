...
api_router.include_router(conversations.router, prefix="/api/v1/conversations", tags=["对话"])
api_router.include_router(tasks.router, prefix="/api/v1/tasks", tags=["任务管理"])
